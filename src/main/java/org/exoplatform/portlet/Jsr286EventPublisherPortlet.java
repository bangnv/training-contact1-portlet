...
public class Jsr286EventPublisherPortlet extends GenericPortlet {
  ...
  protected void doHelp(RenderRequest request, RenderResponse response) throws PortletException,
                                                                       IOException {
//    getPortletContext().getRequestDispatcher("/xhtml/help.jsp").f
  ...
  public void save(ActionRequest request, ActionResponse response) throws PortletException, IOException {
